<template>
  <div class="mt-8">
    ...
    <div class="flex items-center justify-between mb-4">
      <h2 class="text-xl font-bold text-white">Thể loại khác</h2>
      <button
...
const getOtherEvents = async () => {
  try {
    const res = await axios.get('http://127.0.0.1:8000/api/other-events-index');
